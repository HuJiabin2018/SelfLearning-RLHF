    ...
    def run(self):
        ...
        while self.step < self.cfg.num_train_steps:
            ...
            if self.step == (self.cfg.num_seed_steps + self.cfg.num_unsup_steps):
                ...
                if self.step % self.self_learning_steps == 0 and self.self_learning and self.reward_model.isStartSelfLearning:
                    print("Self-learning")
            ...
            self.reward_model.add_data(obs, action, reward, done, episode_success)  # this is only for meta world
